  ...
  return (
    <div className="relative pt-24 pb-32 isolate sm:pt-32">
      ...
      <div className="px-6 mx-auto max-w-7xl lg:px-8">
        ...
        <div className=" relative flex justify-center h-[800px] overflow-hidden max-w-2xl grid-cols-1 grid-rows-1 gap-8 mx-auto mt-16 text-sm leading-6 text-gray-900 sm:mt-20 sm:grid-cols-2 xl:mx-0 xl:max-w-none xl:grid-flow-col xl:grid-cols-4">
          ...
          {testimonials.map((columnGroup, columnGroupIdx) => (
            <div
              key={columnGroupIdx}
              className="flex flex-col space-y-8 gap-[25px] xl:space-y-0 animate-marquee"
            >
              {columnGroup.map((testimonial) => (
                <figure
                  key={testimonial.author.handle}
                  className="p-6 bg-white shadow-lg rounded-2xl ring-1 ring-gray-900/5 animate-fade-in"
                >
          ...
          <div class="absolute inset-x-0 top-0 h-32 pointer-events-none bg-gradient-to-b from-gray-50"></div>
          <div class="absolute inset-x-0 bottom-0 h-32 pointer-events-none bg-gradient-to-t from-gray-50"></div>
        </div>
      </div>
    </div>
  )
