  ...
  return (
    <>
      <div className="relative left-0 top-0 h-[650px] w-full overflow-hidden ">
        ...
        <Container className="absolute left-0 top-[18%] w-full">
          <div className="mt-16 max-w-2xl">
            ...
            <FadeIn delay={2.2} className="flex items-center gap-x-8">
              <p className="mt-6 text-base text-white dark:text-zinc-400">
                Utvecklat tillsammans med trafikskolor i Sverige.
              </p>
            </FadeIn>
          </div>

          <div className="mt-16 flex max-w-sm flex-col gap-2">
